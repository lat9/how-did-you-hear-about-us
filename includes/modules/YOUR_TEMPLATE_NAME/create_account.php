 ...
 * @revised for Zen 1.5.4 adding referral mod by stellarweb Feb 11 2015
...
(customers_info_id, customers_info_number_of_logons, customers_info_date_account_created, customers_info_date_of_last_logon, customers_info_source_id) values ('" . (int)$_SESSION['customer_id'] . "', '0', now(), now(), '". (int)$source . "')";
    $db->Execute($sql);
	  if ($source == '9999') {
